...
<img align="right" src="./media/normalized_triangle_sampler.jpg" width="500" style="padding-left:20px">
...
$\beta'\det( [u,v]) d\beta ' = \frac{\det([u,v])}{2 \cdot 1} d\beta \Leftrightarrow$ 

$\frac{\beta'^2}{2} = \frac{1}{2}\beta +C \Leftrightarrow$

$\beta'= \sqrt{\beta +C} \Leftrightarrow$
